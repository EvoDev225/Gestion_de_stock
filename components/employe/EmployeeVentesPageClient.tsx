...
export default function EmployeeVentesPageClient({ utilisateurId }: { utilisateurId: string }) {
    ...
    const handleConfirmCancel = async () => {
        ...
        try {
            ...
            console.error(error);
            toast.error(error instanceof Error ? error.message : "Erreur lors de l'annulation de la vente.");
        } finally {
